...
vim.keymap.set("n", "<C-d>", "<C-j>", { noremap = true })
vim.keymap.set("n", "<C-u>", "<C-k>", { noremap = true })


-- ai
vim.keymap.set("n", "<leader>ait", ":SupermavenToggle<CR>", { noremap = true })local builtin = require('telescope.builtin')
